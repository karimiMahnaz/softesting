...
import { Route, BrowserRouter, useHistory, Switch, Link } from 'react-router-dom';
...
const Profile = () => {
  const [submitStatus, setSubmitStatus] = useState("Done");
            ...
            axios({
              ...
              .then(response => {
                  ...
                  axios({
                    ...
                    .then( response => {toast.success("ImageName is not updated.", { theme: "colored" });})
                    .catch(error=>{toast.error("ImageName failed to updated.", { theme: "dark" })})
