...
const AboutUs = () => {
     ...
     const { aboutUsFrmShow, setAboutUsFrmShow, setFormsHide } = useContext(VisibilityContext);
          ...
          <div onClick={setOffMenu} onMouseDown ={setFormsHide} >
               <div className={styles.img} style={{ backgroundImage: `url(${img})` }}>
                    <div className={styles.subImg}>
                         ...
                         <p>We help organisations deliver high-quality systems and applications quickly<br />
               ...
               <div className={styles.section4}>
                    <span className={styles.content4}>
                         ...
                         <p>our management team reflect SofTesting's core values of quality, passion, collaboration and innovation. They are supported by highly experienced account directors and specialised technical champions that empower our clients to deliver quality quicker. </p>
               ...
               <div className={styles.section6}>
                    <span className={styles.content6}>
                         <h3>How We Do IT?</h3>
                         <br />
                         <h3>We are a team of Agile Specialists</h3>
                         <br />
                         ...
                         <p>Design and write the code, develop the product and make it alive</p>
                         <p>High Quality of the products</p>
                         <br />
               ...
               <div className={styles.section8}>
                    <span className={styles.content8}>
                         <h3>Our History</h3>
                         <br />
                         <h3>In 2020 SofTesting is founded </h3>
                         <br /> <br />
