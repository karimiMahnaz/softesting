 ...
 //   history.push("/policy");
  ...
  let urlPolicy='';
      ...
      if (location ==='localhost') {
        ...
        urlLinkedinSignIn='https://api.softestingca.com/auth/linkedin/linkedinSignIn';
...
<Desktop>
    ...
    <form className={ registerFrmShow ? styles.modal : styles.inactive} onSubmit={handleSubmit(onSubmit)} style={{ backgroundImage: `url(${img})` }}>
      ...
      <FocusLock>
        <div className={styles.container}>
          ...
          <input id={styles.userName} placeholder="Full Name" onMouseDown={handleKeyDown}
          ...
          <input id={styles.email}  tabIndex="0" ref={emailRef}
            className={`${errors.email ? styles.errorBorder : styles.Border}`} onMouseDown={handleKeyDown}
          ...
          <input id={styles.phone} placeholder="phone Number(with country code)"
            className={`${errors.phone ? styles.errorBorder : styles.Border}`} onMouseDown={handleKeyDown}
            defaultValue="" type="phone" name="phone" tabIndex="0" ref={phoneRef}
            {...register('phone', {
              required: "*",
              pattern: {
          ...
          <input id={styles.password} placeholder="Password" name="password"
            className={`${errors.password ? styles.errorBorder : styles.Border}`} onMouseDown={handleKeyDown}
            defaultValue="" type="password" tabIndex="0" ref={passwordRef}
            {...register('password', {
              required: "*",
              minLength: (6, "*"),
              maxLength: (20, "*"),
          ...
          <input id={styles.coPassword} placeholder="Password Confirm" name="coPassword"
            className={`${errors.coPassword ? styles.errorBorder : styles.Border}`} onMouseDown={handleKeyDown}
            defaultValue="" type="password" tabIndex="0" ref={coPasswordRef}
            {...register('coPassword', {
              required: "*",
              minLength: (6, "*"),
              maxLength: (20, "*"),
          ...
          {errors.coPassword && <p id={styles.cpError} role="alert"  >{errors.coPassword.message}</p>}

          {!yupError && <p id={styles.errorYup} role="alert" > </p>}
          {yupError && <p id={styles.errorYup} role="alert" > Please Try SignIn! </p>}
          ...
          <BrowserRouter>
            ...
            <span id={styles.policy}>By click Sign up, you are in agreement of the <Link id={styles.link} to={`${urlPolicy}`} target="_blank" onClick={handlePolicy}>Terms of use and Privacy policy.</Link></span>
            {/* <Switch>
