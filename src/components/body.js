...
import  img from "../assets/SlideShow/document1-edited.svg";
import  testimg from "../assets/SlideShow/document2-edited.svg";
import  developimg from "../assets/SlideShow/document18-edited.svg";

import mobileImg from "../assets/SlideShow/Mobile/document1.svg";
import mobileTestimg from "../assets/SlideShow/Mobile/document3.svg";
import mobileDevelopimg from "../assets/SlideShow/Mobile/document4.svg";
    ...
    <div className={bodyFrmShow ? styles.body : styles.inactive} onClick={setFormsHide } onMouseEnter={setOffMenu} >
      <Desktop>
        ...
        <div className={styles.testSection2}>
          <h3><strong>Test Better, Test Smarter</strong></h3>
          <h4><strong>Test your releases on time. Make users happy. Grow your business.</strong></h4>
        </div>
        ...
        <div className={styles.developmentsection2}>
          <h3><strong>Realise your vision, why choose SofTesting </strong></h3>
        ...
        <div className={styles.testsection3}>
          <h3><strong>Full-Range QA Services</strong></h3>
        </div>
        ...
        <div className={styles.developsection3}>
          <h1><strong>Modern software for your business success</strong></h1>
        </div>
      ...
      <Tablet>
        ...
        <div className={styles.testcards}>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.card_content}>
              <div >
                <span className={styles.text1}>
                  Our job is to launch, support, <br />
                  and manage the best quality assurance <br />
                  teams to make your product flawless. <br />
                  The hired staff can handle any task and <br />
                  apply the most relevant QA software.
                </span>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.card_content}>
              <span className={styles.text1}>
                In-depth testing is essential for <br />
                any digital project to succeed. Make <br />
                quality the first business priority with us. <br />
                We make sure that no bug spoils user experience<br />
                or affects business metrics.
              </span>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.card_content}>
              <span className={styles.text1}>
                Decrease downtime and reduce testing time <br />
                when outsourcing your QA process. Our proven<br />
                testing practices and test automation tools <br />
                allow us to address issues and meet goals more<br />
                efficiently.
              </span>
        ...
        <section className={styles.one} style={{ backgroundImage: `url(${backimg1})` }}  >
          <div className={styles.subOne}>
            <h2>Progressive Web Apps (PWA) Custom Development Services</h2>
            <span className={styles.onespan}> Imagine a solution that allows you to provide a great mobile user experience that is
              performant, cost-effective, and doesn’t require development across three different platforms. <br />
              That’s what PWAs are all about. Picture it as a combination  of the best sides of
              native mobile apps and websites.</span>
            <h3>PWA benefits for your company</h3>
            <span className={styles.onespan}>Independence from mobile types and systems <br />
              Release your product faster and sooner <br />
              Access to wider promotion methods <br />
              Able to access your app despite being offline <br />
      ...
      <Mobile>
        ...
        <div className={styles.testSection2}>
          <h3><strong>Test Better, Test Smarter</strong></h3>
          <h4><strong>Test your releases on time. Grow your business.</strong></h4>
        </div>
