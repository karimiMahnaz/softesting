...
const Header = () => {
    ...
    const { loginFrmShow, dashboardFrmShow, setDashboardFrmShow, setLoginFrmShow, setBodyFrmShow, setWhatsAppFrmShow , whatsAppFrmShow } = useContext(VisibilityContext);
   ...
   /// let deferredPrompt = null;
    ...
    return (
        <div className={styles.header} >
            <Desktop>
                <button className={styles.signIn} onClick={handleSignIn}>SignIn</button>
                {loginFrmShow ? <SignIn /> : null};
                {/* <button className={styles.signIn} onClick={setRegisterFrmShow}> SignIn </button> 
                                         {registerFrmShow && <SignUp />} */}

                {auth && <a className={styles.welcome} onClick={handleDashboard}>Welcome {emailW}</a>}
    
                {dashboardFrmShow ? <Dashboard /> : null};

                <button ref={appElement} className={styles.App} onClick={handleApp} onMouseOut={handleMouseOut} onMouseOver={handleMouseOver} >
                    <img className={styles.AppIcon} src={downLoadAppIcon} alt="download" />
                </button>
                {downLoadHover && <div className={styles.toolTip} > Download SofTesting App </div>}

                <a id={styles.emailAd} onClick={scrollToContactUs}>hello@SofTestingCa.com</a>
                <a onClick={scrollToContactUs}>
                    <img border="0" alt="email" src={email} className={styles.email}></img>
                </a>
                ...
                <a href="https://www.youtube.com/channel/UCBcHbd6YbpPog5-jR9f9OOA" target="_blank" rel="noopener noreferrer">
                    <img border="0" alt="YouTube" src={YouTube} className={styles.YouTube}></img>
                </a>
                <a href="https://linkedin.com/in/mahnaz-karimi-68042a1a7" target="_blank" rel="noopener noreferrer">
                    <img border="0" alt="linkedin" src={linkedin} className={styles.linkedin}></img>
                </a>
                <a href="https://www.facebook.com/SofTesting-108404168575498" target="_blank" rel="noopener noreferrer">
                    <img border="0" alt="facebook" src={facebook} className={styles.facebook}></img>
                </a>
                ...
                <img border="0" alt="whatsapp" onClick = {handleWhatsApp} src={whatsapp} className={styles.whatsapp}></img>
                     {whatsAppFrmShow? <WhatsApp/>:null}

                <a href="/" onClick={setBodyFrmShow}  >
                    <img border="0" alt="software home" src={home} className={styles.home}></img>
                </a>
            </Desktop>
            <Tablet>
                ...
                <a id={styles.emailAd} onClick={scrollToContactUs} >hello@SofTestingCa.com
                </a>
