...
const OnLineChat = (props) => {
  const { onLineChatFrmShow, setOnLineChatFrmShow, setOffOnLineChatFrmShow,
    onLineChatLoginFrmShow, setOnLineChatLoginFrmShow, aboutUsFrmShow, bodyFrmShow } = useContext(VisibilityContext);
