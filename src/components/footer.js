        ...
        <BrowserRouter>
            <footer className={styles.articleFooter} >
                <Desktop>
                    ...
                    <div className={styles.copyright}> &#9400; Copyright 2021 by SofTesting | <Link id={styles.policy} to= {`${urlPolicy}`} target="_blank" onClick={handlePolicy}>Privacy Policy</Link> | <a id={styles.sitmap} href={`${urlSitemap}`}  target="_blank" >Sitemap</a> </div>
