...
class NavContextProvider extends Component {
    ...
    render() { 
        return ( 
            <NavContext.Provider value={{...this.state  , setShowMenu:this.setShowMenu , setActiveMenu1:this.setActiveMenu1 , setActiveMenu2:this.setActiveMenu2 , setOffMenu:this.setOffMenu}}>
                 {this.props.children}
            </NavContext.Provider>
         );
    }
