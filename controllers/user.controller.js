...
exports.updateProfile = async (req, res, next) => {
    try {
        ...
        const result = await userProfileSchema.updateOne(filter, updateDoc, options);
...
exports.profile = async (req, res, next) => {
    ...
    try {
        ...
        const { userName, phone, email, education, country, companyName, requester, provider, design, develop, security, qa } = req.body;
...
exports.reCaptcha = async (req, res, next) => {
    ...
    try {
        if (!req.body["reCaptcha"] || req.body["reCaptcha"] === undefined || req.body["reCaptcha"] === null) {
...
exports.googleCallback = (req, res, next) => {
    passport.authenticate('google', { failureMessage: 'Google Login Failed', failureRedirect: '/auth/google/failed' }),
        (req, res) => {
...
exports.linkedinSignIn = (req, res, next) => {
    try {
        passport.authenticate('linkedin', { scope: ['profile', 'email'] })(req, res, next);;
    }
    catch (error) {
        next(error);
    }
...
exports.linkedinCallback = (req, res, next) => {
    passport.authenticate('linkedin', { failureMessage: 'linkedin Login Failed', failureRedirect: '/auth/linkedin/failed' }),
        (req, res) => {
...
exports.changePassword = async (req, res, next) => {
    ...
    try {
        ...
        const q = await Usermodel.findOneAndUpdate({ _id: decodedToken.payload.userId }, { password: hash });
